  ...
  render() {
    ...
    if (isEmpty) {
      ...
      content = data.map((row, index) => {
        ...
        return (
          <div>
            <this.RowComponent {...baseRowProps}   attrs={contextmenu ? this.onContext : rowEvents} />
    ...
    return <tbody className={className}>{content} <ContentContextMenu data={this.state}/> </tbody>;
  }
}
